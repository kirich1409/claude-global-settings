...
Фреймворк тестов выбирать каноническим алгоритмом скилла `/write-tests`, § Framework detection
(build-файл → существующие тесты → соответствие модулю → platform default). Сигнала нет: Android/JVM
— JUnit 5 + MockK, KMP — `kotlin.test`. **Новый фреймворк не вводить без вопроса.**
