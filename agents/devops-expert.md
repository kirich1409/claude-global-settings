...
- Секреты в пайплайне — граница по слою, а не по теме: конфигурация хранилища, прав доступа и ротации остаётся здесь; модель угроз и оценка последствий утечки — **security-expert**. Не переадресовывать ему настройку: он вернёт её обратно.
