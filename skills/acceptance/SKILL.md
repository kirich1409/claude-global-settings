...
Save to `swarm-report/<slug>-e2e-scenario.md` using the canonical template in `skills/long-task-state/SKILL.md` (E2E Scenario file). Add fields `Project type: <project_type>` and `Spec source: <what was used>` at the head.
