---
name: drive-to-merge
argument-hint: "<pr|url> [--reviews=<auto|ask>] [--merge=<auto|ask|never>] [--rebase=<yes|no>] [--follow-ups=<yes|no>] [--max-rounds=<N>] [--dry-run]"
description: >
...
| `--dry-run` | Прогнать анализ, один раз нарисовать таблицу решений, ничего не править, не пушить и не постить, затем выйти. |
