...
старта (фаза 1.5), уточнение границ (фаза 1) и разрешение развилок синтеза (5.1), плюс условия STOP
в конце файла. `--autonomous` выключает их все разом — см. таблицу аргументов фазы 1.
