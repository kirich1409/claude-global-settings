...
| Метаданные проекта | Read `app/build.gradle*` / `settings.gradle*`; исходники и версии зависимостей — `~/.claude/rules/jvm-dependencies.md` |
