---
name: rules-swift-concurrency
description: Неочевидные правила Swift Concurrency (@MainActor, Task.detached, Sendable, Swift 6 strict) — применять при написании/правке .swift с конкурентностью.
paths: **/*.swift
---
