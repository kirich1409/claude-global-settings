---
name: rules-swiftui-patterns
description: Структурные паттерны SwiftUI (AnyView vs generics, identity view, ViewModifier) — применять при написании/правке .swift views.
paths: **/*.swift
---
