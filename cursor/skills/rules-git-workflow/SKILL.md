...
description: Git workflow: именование веток, сообщения коммитов, force-push, локальная верификация, PR-модель ~/.claude — применять при работе с git, ветками, коммитами, пушем, worktree.
---
# Git Workflow
