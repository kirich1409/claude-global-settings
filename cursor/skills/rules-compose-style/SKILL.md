---
name: rules-compose-style
description: Неочевидные конвенции и подводные камни Jetpack Compose — применять при написании/правке .kt с Compose UI (Modifier.Node, stability, phase deferral, accessibility).
paths: **/*.kt
---
