---
name: rules-code-policies
description: Политики кода: feature flags, breaking changes, конфигурация, архитектурные решения — применять при добавлении флагов, изменении public API/схемы/CLI, выборе архитектурного подхода.
---
# Политики кода
