---
name: rules-swiftui-performance
description: Правила производительности SwiftUI (гранулярность @Observable, чистота body) — применять при написании/правке .swift views.
paths: **/*.swift
---
