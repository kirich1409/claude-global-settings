---
name: rules-gradle-style
description: Соглашения Gradle build-файлов — применять при правке .gradle, .gradle.kts, libs.versions.toml.
paths: **/*.gradle.kts, **/*.gradle, **/libs.versions.toml
---
