---
name: rules-verify-library-api
description: Верификация library API до написания кода, композиция по стекам, reference implementations — применять перед Edit/Write кода с внешней библиотекой (особенно Compose/SwiftUI/CMP).
---
