---
name: rules-external-sources
description: Маршрутизация внешних источников, обнаружение инструментов, уровни доверия T1–T4 — применять при поиске документации, верификации API, ресёрче.
---
# Внешние источники
