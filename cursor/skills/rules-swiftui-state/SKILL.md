---
name: rules-swiftui-state
description: Управление state в SwiftUI (property wrappers, заморозка @State из init) — применять при написании/правке .swift views со state.
paths: **/*.swift
---
