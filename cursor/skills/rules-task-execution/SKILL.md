---
name: rules-task-execution
description: Выполнение задач: протокол блокирующих ошибок, первопричина над подавлением, ожидание по условию, scope creep — применять при возникновении ошибок, отладке, фоновых операциях.
---
# Выполнение задач
